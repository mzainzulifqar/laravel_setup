                        	...
                        	<div class="chat-sidebar-list">
	                            <div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd" data-wrapper-class="chat-sidebar-list">
	                                ...
	                                <ul class="media-list list-items">
	                                    <li class="media"><img class="media-object" src="{{asset('backend/assets/img/user/user3.jpg')}}" width="35" height="35" alt="...">
	                                    ...
	                                    <li class="media">
	                                        ...
	                                        </div> <img class="media-object" src="{{asset('backend/assets/img/user/user3.jpg')}}" width="35" height="35" alt="...">
	                                        <i class="busy dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media"><img class="media-object" 
	                                    	src="{{asset('backend/assets/img/user/user3.jpg')}}" width="35" height="35" alt="...">
	                                        <i class="online dot"></i>
	                                        <div class="media-body">
